...
from ba_my_robot_msgs.msg import MoveRobotFeedback
from ba_my_robot_msgs.msg import MoveRobotResult
...
class MoveRobotServer:
    ...
    def __init__(self):
        ...
        self._as.start()
        self._current_position = 50     # posisi sekarang si robot, di middle kita asumsikan (50 adalah middle nya, ini asumsi biar gampangnya)
    ...
    def on_goal(self, goal):
        ...
        velocity = goal.velocity    # goal.velocity is 5

        success = False
        preempted = False
        invalid_parameters = False
        message = ""
        rate = rospy.Rate(1.0)  # update every seconds, biar gampang asumsi ke meter/detik nya
        ...
        while not rospy.is_shutdown() and not success and not invalid_parameters:
            ...
            if self._as.is_preempt_requested():
                if goal_position == self._current_position:
                    ...
                    message = "Preempted and stop execution"
                    preempted = True
                break
