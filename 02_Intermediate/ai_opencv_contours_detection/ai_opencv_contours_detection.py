...
def convert_grey_to_binary(gray_image, adaptive, show):
    if adaptive:
...
def draw_contours(image, contours, image_name):
    ...
    # color = (255, 0, 200)   # color of the contour line
...
def main():
    ...
    binary_image = convert_grey_to_binary(gray_image, True, True)
    # binary_image = convert_grey_to_binary(gray_image, False, True)
