...
int main(int argc, char **argv) {
  ...
  ros::init(argc, argv, "robot_ngepel");
  ros::NodeHandle n;
...
// // ========== ini untuk percobaan move cleaner ==========
  // gridClean();
...
double setDesiredOrientation(double desired_angle_radians){
  ...
  // atau yg bawah ini, semakin besar relative_angle_radians semakin cepat dia berputar
...
void spiralClean(){
  ...
  do {
    ...
    cout << "vel_msg.linear.z = " << vel_msg.linear.z << endl;
